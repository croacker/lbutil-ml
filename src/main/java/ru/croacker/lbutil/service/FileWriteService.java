...
public class FileWriteService {
     ...
     * @param documents
     */
    public void writeXml(Map<String, Document> documents) {
        for (String fileName : documents.keySet()) {
            writeXmlFile(fileName, documents.get(fileName));
        }
    }
     ...
     * @param fileName
     */
    private void writeXmlFile(String fileName, Document document) {
        try {
